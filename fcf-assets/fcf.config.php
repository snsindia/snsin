...
// EMAIL MESSAGE
// *************
define('EMAIL_TO', 'webmanager@snsin.com');
define('EMAIL_TO_NAME', 'SNS Website Query');

define('EMAIL_TO_CC', 'mohan@snsin.com');
define('EMAIL_TO_CC_NAME', '');

define('EMAIL_TO_BCC', '');
define('EMAIL_TO_BCC_NAME', '');

define('EMAIL_FROM', 'webmanager@snsin.com');
define('EMAIL_FROM_NAME', 'SNS Web Manager');
